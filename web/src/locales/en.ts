...
export default {
  translation: {
    ...
    settings: {
      ...
      mysqlHostTip: 'Use host.docker.internal for same machine, or RAGFlow server IP for remote',
      ...
      mysqlHelp: 'MySQL credentials can be found in RAGFlow docker/.env file.',
      ragflowTitle: 'RAGFlow API',
      ragflowDesc2: 'Document upload & parsing',
      ragflowOptional: 'Optional',
      ragflowUrl: 'Server URL',
      ragflowUrlTip: 'RAGFlow server address, e.g., http://host.docker.internal:9380',
    ...
    teams: {
      title: 'Team Relations Management',
      member: 'Member',
      role: 'Role',
      ...
      rolePending: 'Pending',
      roleAdmin: 'Admin',
      loadFailed: 'Failed to load team relations',
      ownedTeams: 'My Team Members',
      joinedTeams: 'Joined Teams',
      pendingInvites: 'Pending Invites',
      noMembers: 'No team members',
      noJoinedTeams: 'Not joined any team',
      ...
      addMemberTip: 'Tip',
      addMemberTipDetail: 'Added members will join as regular members and can access shared knowledge bases',
    },
  },
};
